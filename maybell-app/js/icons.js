...
const ICONS = {
  ...
  edit: '<path d="M4 20h4L18.5 9.5a2 2 0 000-2.8l-1.2-1.2a2 2 0 00-2.8 0L4 15v5z"/>',
...
export function icon(name, cls = "") {
  ...
  return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" class="${cls}">${path}</svg>`;
}
